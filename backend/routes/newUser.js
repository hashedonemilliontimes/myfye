...
async function create_new_on_ramp_path(data) {
   ...
   console.log('Processing on-ramp request with data:', JSON.stringify(data, null, 2));
   
   try {
       console.log('About to create new receiver...');
       const receiver = await create_new_receiver();
       // to do save receiver data
       console.log('Receiver created successfully:', JSON.stringify(receiver, null, 2));
       ...
       console.log('Blockchain wallet created successfully:', JSON.stringify(blockchain_wallet, null, 2));
...
async function create_new_receiver() {
    ...
    try {
        ...
        console.error('Error in create_new_receiver:', error.response?.data || error.message);
        throw error;
    }
}
...
async function create_blockchain_wallet(receiverId) {
    ...
    try {
        ...
        console.error('Error in create_blockchain_wallet:', error.response?.data || error.message);
        throw error;
    }
}
