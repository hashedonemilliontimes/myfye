...
import dinari from '../../assets/dinari.png';
  ...
  switch (selectedProduct) {
      ...
      <div>
        ...
        <div style={{display: 'flex', flexDirection: 'row', 
          alignItems: 'center', justifyContent: 'center', marginTop: '-40px'}}>
            <img src={myfyeLogo} style={{width: 'auto', height: isSmallScreen ? '120px' : '200px', marginTop: isSmallScreen ? '20px' : '0px'}}></img>
        </div>
    ...
    textAlign: isSmallScreen ? 'center' : 'left'}}>
        ...
        <div style={{color: '#447E26', 
          fontSize: isSmallScreen ? 'clamp(30px, 5vh, 40px)' : 'clamp(40px, 7.1vh, 80px)',
          fontWeight: 'bold'}}>Your Money, Your Phone.<br/>No Bank Needed.</div>
<div style={{
    color: '#333333',
    fontSize: isSmallScreen ? 'clamp(16px, 2.5vh, 20px)' : 'clamp(20px, 3.1vh, 50px)'
}}>
    Hold <span style={{ fontWeight: 'bold' }}>Stocks</span>, <span style={{ fontWeight: 'bold' }}></span>  
    <span style={{ fontWeight: 'bold' }}> US Gov. Treasury Bonds</span>,<br />
    <span style={{ fontWeight: 'bold' }}>Crypto</span> and more directly on your phone.
</div>

        <div style={{color: '#333333', 
          fontSize: isSmallScreen ? 'clamp(16px, 2.5vh, 20px)' : 'clamp(20px, 3.1vh, 50px)',}}>Send and receive US Dollars
          and Euros instantly from<br/> anywhere in the world <span style={{ fontWeight: 'bold' }}> for free</span>.</div>
...
<div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: isSmallScreen ? '40px' : '0'}}>
<img src = {group136} style={{width: 'auto', height: isSmallScreen ? '400px' : '600px', marginRight: isSmallScreen ? '50px' : '0px'}}/>
</div>
{/*
...
<div style={{height: isSmallScreen ? 'auto' : '100vh', marginTop: isSmallScreen ? '40px' : '10px', marginBottom: '100px', backgroundColor: '#ffffff'}}>

<div style={{padding: isSmallScreen ? '40px 20px' : '100px'}}>
<div style={{color: '#447E26', 
          fontSize: isSmallScreen ? 'clamp(30px, 5vh, 40px)' : 'clamp(40px, 7.1vh, 80px)',
          fontWeight: 'bold',
          textAlign: isSmallScreen ? 'center' : 'left'}}>Our Products</div>
</div>
...
<div onClick={() => setSelectedProduct('stocksAndCrypto')} 
    style={{ cursor: 'pointer',
      color: selectedProduct == 'stocksAndCrypto' ? '#447E26': '#222222',
     }}>Stocks And Crypto</div>
    <div onClick={() => setSelectedProduct('wallet')} 
    style={{ cursor: 'pointer',
      color: selectedProduct == 'wallet' ? '#447E26': '#222222',
     }}>Wallet</div>
    <div onClick={() => setSelectedProduct('earn')}
    style={{ cursor: 'pointer',
      color: selectedProduct == 'earn' ? '#447E26': '#222222',
     }}>Earn</div>
    <div onClick={() => setSelectedProduct('send')} 
    style={{ cursor: 'pointer',
...
<img src={getImageSrc()} style={{height: isSmallScreen ? '30vh' : '50vh', width: 'auto'}}></img>
...
{selectedProduct == 'wallet' && (
  <div style={{display: 'flex', flexDirection: 'column', 
    ...
    height: isSmallScreen ? 'auto' : '45vh'}}>
        ...
        <div style={{color: '#333333', 
          fontSize: isSmallScreen ? 'clamp(24px, 4vh, 30px)' : 'clamp(40px, 6.1vh, 80px)',
          fontWeight: 'bold',
          maxWidth: '520px',
          textAlign: isSmallScreen ? 'center' : 'left',}}>
            Hold US Dollars and Euros 
          Securely With No Bank Account Needed</div>

          <img src={getPoweredByImageSrc()} style={{height:'40px', width: '260px', margin: isSmallScreen ? '20px auto' : '0'}}></img>
...
{selectedProduct == 'earn' && (
  ...
  <div style={{color: '#333333', 
    ...
    textAlign: isSmallScreen ? 'center' : 'left',}}>
      ...
      and Earn 5.1% APY On Your US Dollars</div>  
          <img src={getPoweredByImageSrc()} style={{height:'40px', width: '260px', margin: isSmallScreen ? '20px auto' : '0'}}></img>
          <a 
...
{selectedProduct == 'send' && (
  ...
  <div style={{color: '#333333', 
    ...
    maxWidth: '520px',
    textAlign: isSmallScreen ? 'center' : 'left',}}>
      Send US Dollars and Euros Across the World Instantly For Free</div>  
          <img src={getPoweredByImageSrc()} style={{height:'40px', width: '260px', margin: isSmallScreen ? '20px auto' : '0'}}></img>
          <a 
...
{selectedProduct == 'stocksAndCrypto' && (
  ...
  <div style={{color: '#333333', 
    ...
    maxWidth: '520px',
    textAlign: isSmallScreen ? 'center' : 'left',}}>
      Buy Crypto And Stocks, Store Them Directly On Your Phone</div>  
          <img src={getPoweredByImageSrc()} style={{height:'40px', width: '260px', margin: isSmallScreen ? '20px auto' : '0'}}></img>
          <a 
...
>
  ...
  Learn more about Dinari and RWAs
    ...
    <div style={{fontSize: isSmallScreen ? '30px' : '40px', color: '#124C0A', fontWeight: 'bold'}}>Customer Service</div>
<div style={{fontSize: isSmallScreen ? '20px' : '25px', color: '#000000', textAlign: 'center'}}>We're here to help you with any questions you might have.</div>
...
<HomeContactForm language={lang}/>
  ...
  <div 
      ...
      marginBottom: '50px',
      textAlign: 'center',
      border: goToDashboardIsHovered ?  '2px solid #222222' : '2px solid #222222',
      borderRadius: '20px',
    ...
    >
      SEND US A MESSAGE
        ...
        <div style={{display: 'flex', flexDirection: isSmallScreen ? 'column' : 'row', alignItems: 'center', 
          justifyContent: 'space-between', paddingTop: '20px', width: '100%', maxWidth: '1200px'}}>
        ...
        <div style={{color: '#ffffff', fontSize: isSmallScreen ? '20px' : '25px', marginTop: isSmallScreen ? '20px' : '0'}}>©️ Myfye Ltd. All Rights Reserved</div>
        </div>
