      ...
      <div style={styles.pdfContainer}>
        ...
        {isSmallScreen ? (
          <div style={styles.mobileMessage}>
            <p>For the best viewing experience on mobile devices, please use the link below to view the Terms of Service:</p>
            <a 
          ...
          <div style={styles.errorContainer}>
            <p>Unable to load the Terms of Service PDF.</p>
            <p>
              You can{' '}
              <a 
                href="/Terms of Service.pdf" 
          ...
          <iframe 
            src="/Terms of Service.pdf#toolbar=0&navpanes=0" 
            style={styles.pdf}
