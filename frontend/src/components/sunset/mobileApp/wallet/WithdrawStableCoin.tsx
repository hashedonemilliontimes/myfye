...
function WithdrawStableCoin() {
  const showWithdrawStablecoinPage = useSelector(
    (state: any) => state.userWalletData.showWithdrawStablecoinPage
  );
  ...
  const recentlyUsedSolanaAddresses = useSelector(
    (state: any) => state.userWalletData.recentlyUsedSolanaAddresses
  );
  ...
  const ready = useSelector(
    (state: any) => state.userWalletData.privyWalletReady
  );
  ...
  const checkForValidInput = (newAddress: string, newAmount: string) => {
    ...
    const isValidSolanaAddress = /^[1-9A-HJ-NP-Za-km-z]{32,44}$/.test(
      cleanedAddress
    );
      ...
      if (isNaN(amountToNumber)) {
        ...
        if (transactionSuccess) {
          ...
          if (selectedLanguageCode == "es") {
            ...
            setErrorMessage(
              "Sorry, there was an error with your transaction. Please try again later"
            );
          }
        }
      }
    ...
    <div style={{ backgroundColor: "white" }}>
      {showWithdrawStablecoinPage && (
        ...
        >
          <img
            ...
            src={showWithdrawStablecoinPage ? backButton : menuIcon}
      ...
      >
        ...
        <div>
            ...
            >
              <div
                style={{
                  ...
                  alignItems: "center",
                  background:
                    currencySelected == "usdcSol" ? "#444444" : "#ffffff",
              ...
              >
                ...
                />
                <div id="usdcSolTicker" style={{ marginLeft: "8px" }}>
                  USDC
                </div>{" "}
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  background:
                    currencySelected == "usdtSol" ? "#444444" : "#ffffff",
              ...
              >
                <img
                  ...
                  style={{ width: "40px", height: "auto" }}
                ></img>
                <div style={{ marginLeft: "8px" }}>USDT</div>{" "}
                {/* Adjust marginLeft as needed */}
              </div>
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  background:
                    currencySelected == "eurcSol" ? "#444444" : "#ffffff",
              ...
              >
                ...
                />
                <div id="eurcSolTicker" style={{ marginLeft: "8px" }}>
                  EURC
                </div>{" "}
                {/* Adjust marginLeft as needed */}
              </div>
          ...
          <div
            style={{ marginTop: "20px", fontSize: "20px", marginLeft: "20px" }}
          >
            ...
            <div style={{ marginTop: "30px" }}>
              ...
              >
                ...
                {showAddressesDropdown && (
                  ...
                  >
                    ...
                    {recentlyUsedSolanaAddresses.map(
              ...
              >
                ...
                <input
                  ...
                  placeholder={
                    selectedLanguageCode === "en" ? "Amount" : "Cantidad"
                  }
                />
              </div>
