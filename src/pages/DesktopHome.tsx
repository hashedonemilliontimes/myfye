...
<div style={{
    ...
    Hold <span style={{ fontWeight: 'bold' }}>US Dollars</span>, <span style={{ fontWeight: 'bold' }}>Euros</span>,  
    <span style={{ fontWeight: 'bold' }}> US Treasury Bonds</span>,<br />
    and <span style={{ fontWeight: 'bold' }}>Bitcoin</span> directly on your phone.
</div>

        <div style={{color: '#333333', 
          fontSize: 'clamp(20px, 3.1vh, 50px)',}}>Send and receive US Dollars
...
<div style={{height: '100vh', marginTop: '10px', marginBottom: '100px', backgroundColor: '#ffffff'}}>

<div style={{padding: '100px'}}>
<div style={{color: '#447E26', 
          fontSize: 'clamp(40px, 7.1vh, 80px)',
          fontWeight: 'bold'}}>Our Products</div>
</div>
...
<img src={getImageSrc()} style={{height: '50vh', width: 'auto'}}></img>
  ...
  <div style={{display: 'flex', flexDirection: 'column', 
    ...
    height: '45vh'}}>
        ...
        <div style={{color: '#333333', 
          ...
          <img src={getPoweredByImageSrc()} style={{height:'40px', width: '260px'}}></img>
...
{selectedProduct == 'stocksAndCrypto' && (
  ...
  <div style={{color: '#333333', 
    ...
    maxWidth: '520px',
    textAlign: 'left',}}>
      Buy and Securely Store Bitcoin On Your Phone</div>  
          <img src={getPoweredByImageSrc()} style={{height:'40px', width: '260px'}}></img>
          <a 
