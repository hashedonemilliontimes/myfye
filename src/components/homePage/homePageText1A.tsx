  ...
  return (
    <div style={{display: 'flex', flexDirection: 'column'}}>
        <div style={{fontWeight: 'bold', fontSize: '35px', 
            maxWidth: '500px', marginLeft: '65px', color: '#333333'}}>
            {props.language === 'en' && "A high yield savings account for everyone with internet"}
        ...
        <div style={{fontSize: '25px', 
            maxWidth: '500px', marginLeft: '65px', 
            color: '#333333', marginTop: '15px'}}>


             {props.language === 'en' && "Built on short term US treasury bonds, Myfye gives everyone around the world access to safe, liquid yield with no bank account needed"}
