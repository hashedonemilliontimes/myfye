...
export default function AboutPageText(props: LanguageCodeProps) {
  ...
  return (
    ...
    color: '#333333'
        ...
        {props.language === 'en' && "MyFye takes the USDC that you deposit and invests it in U.S. government bonds. This allows anyone with USDC to earn a stable return from anywhere in the world."}
