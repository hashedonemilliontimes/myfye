...
export default function AboutPageText2(props: LanguageCodeProps) {
  ...
  return (
    ...
    <div style={{ marginLeft: window.innerWidth < 768 ? '15px' : '60px', 
        ...
        {props.language === 'en' && "This is your finance. Just as our name implies, this finance is truly your own. You can ensure your funds grow from the moment you deposit."}
