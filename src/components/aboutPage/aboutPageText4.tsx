...
<div>
    <div>
        ...
        marginLeft: window.innerWidth < 768 ? '15px' : '60px', width: window.innerWidth < 768 ? '90%' : '45vw',
            ...
            To begin growing your wealth with us, simply deposit some stable coin. 
            We'll guide you through the deposit process, and from then on, it grows! You can monitor your money's growth or make withdrawals anytime.
        </div>
        </div>
