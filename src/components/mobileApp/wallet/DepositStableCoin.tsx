...
import { setShowDepositStablecoinPage, setShouldShowBottomNav } from '../../../redux/userWalletData.tsx';

function DepositStableCoin() {
    
    const showDepositStablecoinPage = useSelector((state: any) => state.userWalletData.showDepositStablecoinPage);
...
<div style={{ 
      ...
      zIndex: 6
            ...
            <img style={{width: 'auto', height: '45px', background: 'white'}} src={ showDepositStablecoinPage ? (
